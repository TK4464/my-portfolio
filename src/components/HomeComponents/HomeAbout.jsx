...
const aboutData = [
    {
        ...
        info: [
            {
                title: '呉島 大暉 / Taiki Kureshima\n岡山県出身\n経歴：早稲田大学文化構想学部/地方銀行/HAL東京\n大学のサークルでの広報活動の経験や銀行でのコンサルティングセールスの経験等から、クライアントやユーザーにとって魅力的なサービスを生み出せるようになりたいと考え、WEB業界でクリエイターを目指すことを決意。\n現在はweb制作会社にてフロントエンドエンジニアとして働いています。',
            }
        ],
    },
    {
