            ...
            <div className=' container mx-auto'>
                <div className='mx-2 sm:mx-6 lg:mx-12 pt-12 lg:pt-20 pb-20 lg:pb-40 '>
                    ...
                    <div className='h-full xl:mx-10 2xl:mx-12 pt-10 xl:py-4 '>
                        <div className="container mb-10 mx-auto px-4 md:px-12">

                            {/* 作品画像（グリッド） */}
                            <div className=' h-full lg:grid grid-cols-2 gap-x-20 2xl:gap-x-28 justify-items-center mx-auto mb-10 drop-shadow-lg'>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className=" items-center justify-between leading-tight py-1">
                                                <p className="text-xs sm:text-sm md:text-base text-deep-gray bg-pale-gray p-2 inline-block my-2 rounded py-1">{article.type}</p>
