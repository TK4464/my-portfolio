...
const TimelineData = [
    ...
    {
        date: "2020.04",
        content: "地元の銀行に新卒入社し、約1年間コンサルティングセールスと金融事務を経験。\nここでの経験や学生時代の経験から、クライアントやユーザーにとって本当に魅力的なサービスや価値を届けることを突き詰めた仕事をしたい考えるようになる。"
    },
    {
        date: "2022.01",
        content: "転職活動を行う中で今後のキャリアについて見つめ直す。\nその結果、上記で述べた自身の仕事への考え方に合致し、尚且つ以前から憧れのあったWEBエンジニア・WEBデザイナーといった「サービスを生み出すクリエイティブ側の人間」を目指したいという結論に至る。そして、学ぶなら「最高峰の学校で学びたい」という考えからITの専門学校として有名だったHAL東京への入学を検討。そのための資金集めを始める。"
    },
    {
        date: "2023.04",
                            ...
                            <ul>
                                {TimelineData.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="lg:w-4/5 text-xs sm:text-sm md:text-base lg:float-left lg:border-l-2 lg:border-navy lg:border-solid py-2 lg:py-7 lg:pl-10 lg:before:content-[''] before:bg-navy lg:before:absolute lg:before:w-3 lg:before:h-3 lg:before:left-[123px] lg:before:top-9 lg:before:rounded-full mb-4 lg:mb-0 font-normal">
                                            {/* 配列を改行できるようにする処理 */}
                                            {item.content.split("\n").map((line, i) => (
