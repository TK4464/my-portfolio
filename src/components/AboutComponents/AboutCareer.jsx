...
const TimelineData = [
    ...
    {
        date: "2020.04",
        content: "地元の銀行に新卒入社し、約1年間コンサルティングセールスと金融事務を経験。\nここでの経験や学生時代の経験から、私自身が大きなやりがいを感じるのは「クライアントやユーザーに自信を持って提案できる魅力的なサービスや価値を届けることができる仕事」や「私自身が仕事上で追い求めていく数字がクライアントやユーザーの利益に直接繋がる仕事」だということに気づく。"
    },
    {
        date: "2022.01",
        content: "転職活動を行う中で今後のキャリアについて見つめ直す。\nその結果、上記で述べた自身の仕事への考え方に合致し、尚且つ以前から憧れのあったフロントエンドエンジニア・WEBデザイナーといった「サービスを生み出すクリエイティブ側の人間」を目指す決意をする。そして、学ぶなら「最高峰の学校で学びたい」という考えからITの専門学校として有名だったHAL東京への入学を検討。そのための資金集めを始める。"
    },
    {
        date: "2023.04",
